...
OFILES = main.o myLib.o deluxegalaga.o space.o ship.o bee.o dragonfly.o bullet.o enemybullet.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h deluxegalaga.h space.h ship.h bee.h dragonfly.h bullet.h enemybullet.h
